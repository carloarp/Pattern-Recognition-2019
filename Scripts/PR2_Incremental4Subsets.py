### Incremental PCA using 4 subsets
...
def divide_training_data_into_4_subsets(x_train, y_train, train_size,show):
...
def main():	
	...
	x_subsets, y_subsets = divide_training_data_into_4_subsets(X_train,Y_train,train_size,show='no')
	...
	def merge_subsets(x_subset1,x_subset2,y_subset1,y_subset2,combined_df,name,show,plot,save):
		...
		plot_df(reconstruction_error_batch_df, reconstruction_error_inc_df, 
				plot_title='Batch vs Incremental Reconstruction Error', 
		...
		plot_df(success_rate_batch_df, success_rate_inc_df, 
				plot_title='Batch vs Incremental Success Rate', 
	...
	#export_csv = combined_df.to_csv ('4Subsets_IncrementalResults.csv', index = None, header=True) 
	...
	export_csv = training_time_df.to_csv ('4Subsets_TrainingTime.csv', index = None, header=True) 
