...
HD_NN_classifier(M_list_NN,A_train,A_test,Y_train,Y_test,eigenvectors_hd,mode='plot mem',save='no')	# mode='plot time'/'plot rate'/'plot mem'/'print', save=yes/no
